    ...
    <div class="container hero-container">
      <div class="hero-text-content">
        ...
        <h1 class="hero-title">
          ...
          <div class="line-wrapper"><span class="line text-cyan">el Paciente</span></div>
        </h1>
        ...
        <div class="hero-actions">
          <button class="btn-primary" @click="router.push('/longevidad-regenerativa')">
            <i class="fa-regular fa-compass"></i> Conoce Nuestra Filosofía
          </button>
        </div>

        <div class="hero-logos">
          <span class="logo-item">Eternal Medical Center</span>
          <span class="logo-divider">|</span>
          <span class="logo-item">PowerHouse Biotech</span>
        </div>
      </div>
    </div>
  </section>
...
.hero-section {
  ...
  display: flex; align-items: center; justify-content: center; padding: 100px 0 10rem;
...
.hero-container {
  ...
  z-index: 2; position: relative; width: 100%; height: 100%; text-align: center;
}

.hero-text-content {
  width: 100%; max-width: 1000px; display: flex; flex-direction: column; align-items: center; justify-content: center;
...
.hero-tag {
  ...
  letter-spacing: 0.25em; color: var(--color-cyan); margin-bottom: 2rem;
  padding: 0.6rem 1.5rem; border: 1px solid rgba(229, 213, 181, 0.4);
  border-radius: 50px; background: rgba(20, 20, 20, 0.5);
  backdrop-filter: blur(10px); display: inline-block;
  box-shadow: 0 10px 30px rgba(0, 0, 0, 0.5);
}

.hero-title {
  font-size: 6rem; line-height: 1.05; margin-bottom: 1rem; font-weight: 800;
  text-transform: uppercase; color: #ffffff; perspective: 1000px;
  ...
  .line-wrapper { overflow: hidden; padding-bottom: 0.2rem; }
  .line { display: block; will-change: transform, opacity; transform-origin: bottom center; }
  .text-cyan {
...
.hero-subtitle {
  ...
  color: #e4e4e7; font-family: var(--font-secondary);
  letter-spacing: -0.02em; text-shadow: 0 10px 20px rgba(0, 0, 0, 0.8);
  @media (max-width: 768px) { font-size: 1.5rem; }
}

.hero-roles {
  font-size: 1.1rem; color: var(--color-cyan); margin-bottom: 0.75rem;
  font-weight: 600; letter-spacing: 0.1em; text-transform: uppercase;
  display: flex; gap: 0.75rem; flex-wrap: wrap; justify-content: center;
  .role-sep { color: rgba(255, 255, 255, 0.3); }
}
...
.hero-desc {
  padding: 16px; font-size: 1.4rem; color: #ffffff; max-width: 750px;
  margin-bottom: 3rem; line-height: 1.8; font-style: italic; font-weight: 300;
...
.hero-logos {
  ...
  gap: 1rem; padding: 1rem 2.5rem; background: rgba(20, 20, 20, 0.4);
  backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.1);
  border-radius: 50px;
  .logo-item { font-size: 0.9rem; font-weight: 700; color: var(--text); letter-spacing: 0.1em; }
  .logo-divider { color: rgba(255, 255, 255, 0.2); }
  @media (max-width: 480px) { flex-direction: column; gap: 0.5rem; border-radius: 16px; .logo-divider { display: none; } }
}
...
.purpose-text { display: flex; flex-direction: column; align-items: flex-start; text-align: left;
...
.purpose-paragraph {
  font-size: 1.15rem; line-height: 1.8; color: var(--text-muted); margin-bottom: 1.5rem;
  &.highlight { color: var(--text); font-weight: 600; font-size: 1.2rem; }
}

.purpose-quote {
  font-size: 1.3rem; line-height: 1.6; color: var(--text); font-weight: 500; font-style: italic;
  border-left: 3px solid var(--color-cyan); padding: 1.5rem 0 1.5rem 2rem;
  margin: 1.5rem 0 2rem; background: rgba(56, 182, 255, 0.03);
